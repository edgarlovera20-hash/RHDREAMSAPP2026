        ...
        <div className="w-full lg:w-auto lg:min-w-[330px] flex items-center justify-between gap-3 bg-slate-950/70 p-4 rounded-xl border border-white/10 shadow-inner">
          ...
          {!isLoggedInWithGoogle ? (
            <button
              ...
              className="relative overflow-hidden bg-white hover:bg-gray-50 text-gray-700 font-bold text-xs px-4 py-2.5 rounded-xl cursor-pointer transition-all flex items-center gap-2.5 shadow-[0_2px_8px_rgba(66,133,244,0.3),0_0_0_2px_rgba(66,133,244,0.15)] hover:shadow-[0_4px_16px_rgba(66,133,244,0.45),0_0_0_2px_rgba(66,133,244,0.3)] border-0"
              style={{ background: 'linear-gradient(white, white) padding-box, linear-gradient(135deg,#4285F4,#34A853,#FBBC05,#EA4335) border-box', border: '2px solid transparent' }}
            >
              ...
              <span className="bg-gradient-to-r from-[#4285F4] via-[#34A853] to-[#EA4335] bg-clip-text text-transparent font-bold">
                Conectar Google
              </span>
            </button>
          ) : (
